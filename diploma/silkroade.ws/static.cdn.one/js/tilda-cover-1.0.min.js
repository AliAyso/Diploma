...
function cover_init(e) {
    ...
    if (n) {
        ...
        var v = u.some((function(e) {
            ...
            l, s;
        if ((window.t_cover__isMobile || "ontouchend" in document) && v && !o && (n.style.backgroundImage = 'url("' + c["cover-bg"] + '")'), t_cover__isEditMode())
            if (window.t_cover__isMobile) t_cover__setHeightForMobile(r, [".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper"]);
...
function t_cover__setCoverVideoParams(e, t, o, r) {
    var n = "";
    if (t["video-url-youtube"] && (n = "youtube"), (t["video-url-vimeo"] || t["video-url-rutube"] || t["video-url-kinescope"] || t["video-url-vkvideo"]) && (n = "iframe"), (!window.t_cover__isMobile && !("ontouchend" in document) || -1 === ["on", null].indexOf(t["use-image-for-mobile-cover"])) && o) switch (t_cover__setStylesForCoverVideo(e, "youtube" === n ? "youtube" : ""), n) {
        case "youtube":
...
function t_cover__recalcCoverHeight(e, t) {
    ...
    if (o) {
        ...
        if (r && "935" !== n) {
            ...
            p > m && g < p + h || d || (window.t_cover__isMobile || "ontouchend" in document) && t ? (t_cover__setRecalculatedHeight(o, p), t_cover__updateResizeElem(o)) : window.t_cover__isMobile && y ? t_cover__setHeightForMobile(o, _) : g > p + h && (t_cover__setRecalculatedHeight(o, p), t_cover__updateResizeElem(o))
        }
    }
}
...
function t_cover__setRecalculatedHeight(e, t) {
    ...
    var u = t > i ? t : i,
        v = 0,
        l = [".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper"],
        s = 0,
        g = {},
        f;
    [{
        selector: ".t-cover-outer",
        paddingContainer: ".t-cover-outer"
    }, {
        selector: ".t995",
        paddingContainer: ".t995__wrapper"
    }].forEach((function(t) {
        e.querySelector(t.selector) && (g = t_cover__getContainersPaddings(e.querySelector(t.paddingContainer)), s = g.top + g.bottom)
    })), u -= s, (a || e.querySelector(".t734")) && l.push(".t-slds__items-wrapper"), l.forEach((function(t) {
        var o;
...
function t_cover__setHeightForMobile(e, t) {
    t.forEach((function(t) {
        var o = e.querySelector(t),
            r = 0;
        t_cover__isEditMode() && (r = MENU_HEIGHT, e.querySelector(".t995") && (r += 40)), o && (o.style.height = document.documentElement.clientHeight - r + "px")
    }))
}
