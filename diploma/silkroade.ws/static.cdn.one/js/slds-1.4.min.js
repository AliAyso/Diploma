            ...
            if (!i.getAttribute("data-slider-initialized")) {
                ...
                if (d) {
                    ...
                    if (Array.prototype.forEach.call(d, (function(t, e) {
                        ...
                        g ? v = parseInt(g, 10) : i.setAttribute("data-slider-pos", 1), i.setAttribute("data-slider-cycle", ""), i.setAttribute("data-slider-animated", ""), a || t_slds__createDummies(o, n, i), c = parseInt(i.getAttribute("data-slider-items-in-row"), 10) || 0;
                        ...
                        })), t_slds_initSliderControls(t, e), t_slds_updateSlider(t)), i.getAttribute("data-slider-timeout") > 0 ? t_slds_initAutoPlay(t, v, l, e) : i.addEventListener("slideAutoplayTimerReady", (function() {
                            i.getAttribute("data-slider-timeout") > 0 && t_slds_initAutoPlay(t, v, l, e)
                        })), s.querySelectorAll(".t-slds__item-loaded").length < l + 2 && t_slds_UpdateImages(t, v), "yes" == i.getAttribute("data-slider-arrows-nearpic") && t_slds_positionArrows(t);
...
function t_slds__createDummies(t, e, s) {
    ...
    if (t) {
        ...
        _ && (o = !0, _.classList.contains("t-zoomable") && _.classList.remove("t-zoomable"), _.removeAttribute("data-zoomable"))
    }
    if (e) {
        var c = e.querySelector('[data-zoomable="yes"]');
        c && (n = !0, c.classList.contains("t-zoomable") && c.classList.remove("t-zoomable"), c.removeAttribute("data-zoomable"))
    }
    ...
    if (!l && t && !s.querySelector('.t-slds__item[data-slide-index="' + (r + 1) + '"]')) {
        var m = t.cloneNode(!0);
        if (m.setAttribute("data-slide-index", r + 1), m.classList.remove("t-slds__item_active"), m.setAttribute("aria-hidden", "true"), e.insertAdjacentElement("afterend", m), e.classList.add("t-slds__item-loaded"), a > 0 && "true" === d)
    ...
    o && (_.classList.add("t-zoomable"), _.setAttribute("data-zoomable", "yes")), n && (c.classList.add("t-zoomable"), c.setAttribute("data-zoomable", "yes"))
}
...
function t_slds__hideMobileSlides(t) {
    if (t) {
        ...
        if (!s || "scroll" !== s.overflowX || "flex" !== s.display) {
            ...
            if (!(i.length <= 2 * r)) {
                for (var a = t.getAttribute("data-slide-index"), d = [a = parseInt(a, 10)], l = 1; l < r; l++) a + l <= i.length ? d.push(a + l) : d.push(l), a - l > 0 ? d.push(a - l) : d.push(i.length + 1 - l);
...
function t_slideMoveWithoutAnimation(t, e, s) {
    ...
    if (i) {
        ...
        if (r) {
            ...
            if (_) {
                var c, u;
                if ("function" == typeof window.CustomEvent) var c = new CustomEvent("tildaSldsMoveSlideStart"),
                    u = new CustomEvent("tildaSldsMoveSlideEnd");
                else(c = document.createEvent("CustomEvent")).initCustomEvent("tildaSldsMoveSlideStart", !0, !0), (u = document.createEvent("CustomEvent")).initCustomEvent("tildaSldsMoveSlideEnd", !0, !0);
                i.dispatchEvent(c)
            }
            if (n) {
                ...
                if (p && 0 === i.querySelectorAll(".t-slds__item_dummy").length) {
                    var m = p.cloneNode(!0);
                    if (m.classList.add("t-slds__item_dummy"), m.style.position = "absolute", m.style.left = l * a + "px", r.appendChild(m), i.classList.contains("js-product")) y = i;
                    else var y = i.querySelector(".t-store") || i.querySelector(".js-product");
        ...
        if (r) {
            ...
            if (a > o + 1 && (a = 1), n) {
                ...
                if (_ && 0 === i.querySelectorAll(".t-slds__item_dummy").length) {
                    var c = _.cloneNode(!0);
                    c.classList.add("t-slds__item_dummy"), c.style.position = "absolute", c.style.left = l * a + "px", r.appendChild(c), t_slds_fadeOut(c, 400, (function() {
    ...
    if (i) {
        ...
        if (r) {
            ...
            var h = !!navigator.userAgent.match("CriOS"),
                S;
            if (_ || 0 === _ || (_ = 300), c > u + 1 && (c = 1, r.setAttribute("data-slider-pos", 1)), "true" !== r.getAttribute("data-slider-stop")) {
                if (y)
                    if (d) {
                        var w = a[a.length - 1],
                            q = parseInt(w.getAttribute("data-slide-index"), 10);
                        if (l < u && t_slds_fadeIn(y, 300), q < u && l > 0 && (c == q - o + 1 || q === o)) {
                    ...
                    } else "false" == r.getAttribute("data-slider-with-cycle") && (c == u || l > 1 && c == u - l + 1) ? t_slds_fadeOut(y, 300) : t_slds_fadeIn(y, 300);
                v && ("false" == r.getAttribute("data-slider-with-cycle") && 1 == c ? t_slds_fadeOut(v, 300) : t_slds_fadeIn(v, 300)), r.classList.add("t-slds_animated"), A >= 13 && h && !f ? t_slide_MoveAnimation(r, c, n, _) : r.style.transform = "translateX(-" + n * c + "px)", t_triggerEvent(r, "slideChangeStart"), setTimeout((function() {
                ...
                }), _), t_slds_ActiveBullet(t, c, u, s), t_slds_ActiveSlide(t, c, u), "true" == r.getAttribute("data-slider-correct-height") && t_slds_SliderHeight(t), t_slds_SliderArrowsHeight(t), t_slds_ActiveCaption(t, c, u), i.querySelectorAll(".t-slds__item-loaded").length < u + 2 && t_slds_UpdateImages(t, c)
            }
        }
    }
}
...
function t_slds_updateSlider(t) {
    ...
    if (e) {
        ...
        if (s) {
            ...
            l > o + 1 && (l = 1, s.setAttribute("data-slider-pos", 1)), _ && (_.style.display = "false" === n && (o - i <= 0 || l === o) ? "none" : ""), s.style.transform = "translateX(-" + d * l + "px)", "true" == s.getAttribute("data-slider-correct-height") && t_slds_UpdateSliderHeight(t), t_slds_UpdateSliderArrowsHeight(t)
        }
    }
}
...
function t_slds_ActiveBullet(t, e, s, i) {
    ...
    if (l) {
        ...
        if (Array.prototype.forEach.call(o, (function(t) {
            ...
            })), i && i.thumbsbulletGallery && e >= r && e != s + 1 || s >= r && 0 == e ? n = l.querySelector('.t-slds__bullet[data-slide-bullet-for="' + r + '"]') : 0 == e ? n = l.querySelector('.t-slds__bullet[data-slide-bullet-for="' + s + '"]') : e == s + 1 && (n = l.querySelector('.t-slds__bullet[data-slide-bullet-for="1"]')), n) {
...
function t_slds_ActiveSlide(t, e, s) {
    ...
    if (i) {
        ...
        if (Array.prototype.forEach.call(a, (function(t) {
            ...
            })), 0 == e && !1 === l) i.querySelector('.t-slds__item[data-slide-index="' + s + '"]').classList.add("t-slds__item_active"), i.setAttribute("aria-hidden", "false");
        else if (0 == e && !0 === l) d = i.querySelector('.t-slds__item[data-slide-index="' + s + '"]');
        else if (e == s + 1 && !1 === l) {
            var c = i.querySelector('.t-slds__item[data-slide-index="1"]');
            c && (c.classList.add("t-slds__item_active"), c.setAttribute("aria-hidden", "false"))
        } else e == s + 1 && !0 === l && (d = i.querySelector('.t-slds__item[data-slide-index="1"]'));
        d && (d.classList.add("t-slds__item_active"), d.setAttribute("aria-hidden", "false")), window.t_slds__isiOS && t_slds__hideMobileSlides(d), t_slds__setTabindexForFocusableElements(t)
    }
}
    ...
    if (e) {
        ...
        if (s) {
            ...
            if ("true" != o.getAttribute("data-slider-stop")) {
                var _ = 0;
                o && (_ = o.getAttribute("data-slider-items-in-row"), o.style.width = d * l + "px"), window.innerWidth <= 640 ? _ = 1 : window.innerWidth <= 960 && _ > 1 && (_ = 2);
                var c = _ > 1 ? d / _ : d;
                if (c > 0) {
                    var u = e.querySelectorAll(".t-slds__item");
                    o && (u = o.querySelectorAll(".t-slds__item")), Array.prototype.forEach.call(u, (function(t) {
                        t.style.width = c + "px"
                    }))
                }
            }
    ...
    if (a) {
        ...
        if (l) {
            var o = parseFloat(l.getAttribute("data-slider-timeout")),
                ...
                c;
            if (_ && clearInterval(_), "true" !== l.getAttribute("data-slider-stop")) {
                var u;
                ...
                }))), void 0 !== document.hidden ? (m = "hidden", y = "visibilitychange") : void 0 !== document.msHidden ? (m = "msHidden", y = "msvisibilitychange") : void 0 !== document.webkitHidden && (m = "webkitHidden", y = "webkitvisibilitychange"), document.addEventListener(y, (function() {
                ...
                var v = setInterval((function() {
                    ...
                    "yes" != r && "yes" != d && "yes" != o && ("false" == l.getAttribute("data-slider-with-cycle") && e == s ? e = s : e++, l.setAttribute("data-slider-pos", e), e != s + 1 && 0 != e || (n = "yes"), t_slideMoveWithoutAnimation(t, !0, i, _), t_slds_updateSlider(t), "yes" == n && (e == s + 1 && (e = 1), 0 == e && (e = s), l.setAttribute("data-slider-pos", e)), l.setAttribute("data-slider-cycle", n))
                }), o);
            ...
            if (d) {
                ...
                if ("true" !== d.getAttribute("data-slider-stop"))
                    if ("true" !== d.getAttribute("data-swiper-initialized")) {
                        ...
                        else u(p), window.addEventListener("scroll", (function() {
                        ...
                        if (1 != e) {
                            ...
                            window.removeEventListener("touchmove", m, {
                                ...
                                var s = r.querySelector(".t-slds__items-wrapper"),
                                    ...
                                    m = 30,
                                    y;
                                if ("true" !== s.getAttribute("data-slider-stop") && (s.setAttribute("data-slider-touch", "yes"), t_slds_scrollImages(t, l * _ - p), e.isFinal)) {
                                    if (e.velocityX > .4) "false" == s.getAttribute("data-slider-with-cycle") && 1 == _ ? _ = 1 : _--, s.setAttribute("data-slider-pos", _), 0 == _ && (u = "yes"), s.setAttribute("data-slider-cycle", u), t_slideMove(t, !1, i);
                                    else if (e.velocityX < -.4) {
                                        if ("false" == s.getAttribute("data-slider-with-cycle") && (_ == c || d && _ == c - a + 1)) _ = d ? c - a : c;
                                        else {
                                        ...
                                        s.setAttribute("data-slider-pos", _), _ == c + 1 && (u = "yes"), s.setAttribute("data-slider-cycle", u), t_slideMove(t, !1, i)
                                    } else f <= -30 / c ? ("false" == s.getAttribute("data-slider-with-cycle") && (_ == c || d && _ == c - a + 1) ? _ = d ? c - a : c : _++, s.setAttribute("data-slider-pos", _), _ == c + 1 && (u = "yes"), s.setAttribute("data-slider-cycle", u), t_slideMove(t, !1, i)) : f >= m / c ? ("false" == s.getAttribute("data-slider-with-cycle") && 1 == _ ? _ = 1 : _--, s.setAttribute("data-slider-pos", _), 0 == _ && (u = "yes"), s.setAttribute("data-slider-cycle", u), t_slideMove(t, !1, i)) : t_slideMove(t, !1, i);
